...
export interface FlowDataDemention {
...
export interface FlowDataDementionWithQuantiles extends FlowDataDemention {
  quantiles: Quantiles;
}
...
export interface FlowData {
  u: FlowDataDemention;
  v: FlowDataDemention;
  speed?: FlowDataDementionWithQuantiles;
  width: number;
  height: number;
  bounds: {
    west: number;
