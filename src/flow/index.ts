...
import { type FlowLayerOptions, type FlowData, type FlowDataAtLonLat } from './types';
...
export class FlowLayer {
  ...
  /**
   * FlowLayer class for visualizing wind field data with particle animation in Cesium.
   * 
   * @class
   * @param {Viewer} viewer - The Cesium viewer instance.
   * @param {FlowData} flowData - The wind field data to visualize.
   * @param {Partial<FlowLayerOptions>} [options] - Optional configuration options for the wind layer.
   ...
   * @param {FlowData} data - The new wind data to apply.
   */
...
export type { FlowLayerOptions, FlowData, FlowLayerEventType, FlowLayerEventCallback };
