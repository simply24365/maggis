...
import { type FlowLayerOptions } from './types';
...
export class FlowParticlesRendering {
  ...
  private createPrimitives() {
    const segments = new CustomPrimitive({
      ...
      uniformMap: {
        minimum: () => new Cartesian2(this.computing.flowData.bounds.west, this.computing.flowData.bounds.south),
        maximum: () => new Cartesian2(this.computing.flowData.bounds.east, this.computing.flowData.bounds.north),
        ...
        postProcessingPosition: () => this.computing.particlesTextures.nextParticlesPosition,
